...
(scales percent | percent scale): "labels = scales::label_percent(accuracy = 1)"
...
# WoS data
get articles: 'get_data("articles")'
get addresses: 'get_data("addresses")'
get institutes: 'get_data("institutes")'
get categories: 'get_data("categories")'
