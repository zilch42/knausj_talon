...
mod.list("py_plotnine")
ctx.lists["user.py_plotnine"] = {
    "coord cartesian": "pn.coord_cartesian",
    "element blank": "pn.element_blank",
    "element text": "pn.element_text",
    "ex label":"pn.xlab",
    "facet grid": "pn.facet_grid",
    "facet wrap": "pn.facet_wrap",
    "graph A B line": "pn.geom_abline",
    "graph aesthetic": "pn.aes", 
    "graph area": "pn.geom_area",
    "graph bar": "pn.geom_bar",
    "graph boxplot": "pn.geom_boxplot",
    "graph column": "pn.geom_col",
    "graph density": "pn.geom_density",
    "graph histogram": "pn.geom_histogram",
    "graph horizontal line": "pn.geom_hline",
    "graph labels": "pn.labs",
    "graph line": "pn.geom_line",
    "graph plot": "pn.ggplot", 
    "graph point": "pn.geom_point",
    "graph pointrange": "pn.geom_pointrange",
    "graph ribbon": "pn.geom_ribbon",
    "graph smooth": "pn.geom_smooth",
    "graph text": "pn.geom_text",
    "graph vertical line": "pn.geom_vline",
    "graph violin": "pn.geom_violin",
    "labs": "pn.labs",
    "scale colour manual": "pn.scale_colour_manual",
    "scale colour viridis": "pn.scale_colour_viridis_c",
    "scale ex continuous": "pn.scale_x_continuous", 
    "scale ex discrete": "pn.scale_x_discrete", 
    "scale fill manual": "pn.scale_fill_manual",
    "scale fill viridis": "pn.scale_fill_viridis_c",
    "scale why continuous": "pn.scale_y_continuous", 
    "scale why discrete": "pn.scale_y_discrete", 
    "theme minimal": "pn.theme_minimal",
    "theme set": "pn.theme_set",
    "theme": "pn.theme",
    "why label":"pn.ylab",
    "why limit": "pn.ylim",
}