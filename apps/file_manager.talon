...
toggle pickers: user.file_manager_toggle_pickers()
pickers refresh: user.file_manager_update_lists()
go (desk | desktop): user.file_manager_open_user_directory("Desktop")
