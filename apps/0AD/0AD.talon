...
visible idle: user.select_all_on_screen(1, "i")
visible (workers|villagers): user.select_all_on_screen(1, "alt", "y")
idle fighter: key(/)
add fighter: key(shift-/)
all idle fighters: key(alt-/)
visible fighters: user.select_all_on_screen(1, "alt")
visible wounded: user.select_all_on_screen(1, "o")
visible (units|all): user.select_all_on_screen()
add visible: user.select_all_on_screen(1, "shift")
select small: user.select_small()
# idle unit: key(\)
# add unit: key(shift-\)
# all idle : key(alt-\)
