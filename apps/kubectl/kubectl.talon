...
# custom commands 
cube namespace: "sip-bibliomet-k8"
cube pod name: "sip-cronjob"
cube delete job: "kubectl delete cronjob sip-cronjob -n sip-bibliomet-k8"
cube update job: "kubectl apply -f kubernetes/sip-pod-cron.yaml"
